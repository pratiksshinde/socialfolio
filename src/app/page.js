      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl border border-orange-500/30 rounded-2xl p-8 shadow-2xl shadow-orange-500/20">
          ...
          <button
            ...
            className={`w-full flex items-center justify-center space-x-2 px-6 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform ${
              !file || loading
          ...
          {/* Status Messages */}
          {status && (
            <div className={`mt-6 p-4 rounded-lg flex items-start space-x-3 transition-all duration-300 ${
              error 
